// SPDX-License-Identifier: MIT
    ...
    contract Seppuku is ERC721, Ownable, ERC721Enumerable {
      ...
      event SeppukuMinted(uint256 tokenId, address owner);
      ...
      function mintSeppuku(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit SeppukuMinted(id, msg.sender);
          }
        }
      }
    
      function presaleSeppuku(uint256 numberOfTokens) external payable {
