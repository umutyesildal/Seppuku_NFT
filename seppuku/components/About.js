              ...
              <div className="py-8 space-y-4 text-base leading-6 text-gray-700 sm:text-lg sm:leading-7">
                <ul className="space-y-2 list-disc">
                  ...
                  <li className="flex items-start">
                    ...
                    <p className="ml-2">0.019 ETH per Seppuku.</p>
                  </li>
                </ul>
              </div>
              <div className="pt-6 text-base leading-6 font-extralight sm:text-lg sm:leading-7">
                <p>
                  {`Often called “hara-kiri” in the West, “seppuku” is a form of ritual suicide that originated with Japan’s
                   ancient samurai warrior class. The doomed individual often drank sake and composed a short “death poem” 
                   before taking up the blade.`}
                </p>
                <p className="mt-8">
                  <Link href="#main">
